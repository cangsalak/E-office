...
$query = "INSERT INTO the_user (userId,email,password,userName,categoryId,positionId,positionId2,positionId3) VALUES ('$userId','$email','$encryption','$userName','$categoryId','$positionId','$positionId2','$positionId3')";
